...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SafeInsure Core"),
     ...
     * override -datadir in the safeinsure.conf file in the default data directory
     * (to be consistent with safeinsured behavior)
     */
    if (dataDir != getDefaultDataDirectory())
