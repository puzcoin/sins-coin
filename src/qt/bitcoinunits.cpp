...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SINS);
    unitlist.append(mSINS);
    unitlist.append(uSINS);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SINS:
            return QString("SINS");
        case mSINS:
            return QString("mSINS");
        case uSINS:
            return QString::fromUtf8("μSINS");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SINS:
            return QString("tSINS");
        case mSINS:
            return QString("mtSINS");
        case uSINS:
            return QString::fromUtf8("μtSINS");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SINS:
            return QString("SINS");
        case mSINS:
            return QString("Milli-SINS (1 / 1" THIN_SP_UTF8 "000)");
        case uSINS:
            return QString("Micro-SINS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SINS:
            return QString("TestSINSs");
        case mSINS:
            return QString("Milli-TestSINS (1 / 1" THIN_SP_UTF8 "000)");
        case uSINS:
            return QString("Micro-TestSINS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
