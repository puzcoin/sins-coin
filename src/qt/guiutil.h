...
/** Utility functions used by the SafeInsure Qt UI.
 */
namespace GUIUtil
{
...
// Render SafeInsure addresses in monospace font
...
// Parse "safeinsure:" URI into recipient object, return true on successful parsing
