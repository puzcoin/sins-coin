                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SafeInsure Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SafeInsure address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and safeinsure: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SafeInsure Core"), this);
    aboutAction->setStatusTip(tr("Show information about SafeInsure Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SafeInsure"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SafeInsure addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SafeInsure addresses"));
    ...
    openAction->setStatusTip(tr("Open a SafeInsure: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SafeInsure Core help message to get a list with possible SafeInsure command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SafeInsure Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SafeInsure network", "", count));
}
...
{
    QString strTitle = tr("SafeInsure Core"); // default title
